...
func (ud *userDomainService) FindUserByEmailServices(email string) (users_domain.UserDomainInterface, *rest_err.RestErr) {
	logger.Info("Init FindUserByEmailServices", zap.String("journey", "FindUserByEmailServices"))
	return ud.userRepository.FindUserByEmail(email)
}

func (ud *userDomainService) FindUserByIDServices(id string) (users_domain.UserDomainInterface, *rest_err.RestErr) {
